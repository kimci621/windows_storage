...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _checkInputsforNum__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./checkInputsforNum */ "./src/js/modules/checkInputsforNum.js");
...
const modalDatainfo = modalsData => {
  ...
  Object(_checkInputsforNum__WEBPACK_IMPORTED_MODULE_0__["default"])('#width');
  Object(_checkInputsforNum__WEBPACK_IMPORTED_MODULE_0__["default"])('#height');
...
/* harmony default export */ __webpack_exports__["default"] = (modalDatainfo);

/***/ }),

/***/ "./src/js/modules/checkInputsforNum.js":
/*!*********************************************!*\
  !*** ./src/js/modules/checkInputsforNum.js ***!
  \*********************************************/
/*! exports provided: default */
...
/* harmony default export */ __webpack_exports__["default"] = (numChecker);
...
const forms = formObj => {
  ...
  Object(_checkInputsforNum__WEBPACK_IMPORTED_MODULE_0__["default"])('input[name="user_phone"]');
  const message = {
...
const tabs = ({
  ...
  parent.addEventListener('click', e => {
    if (e.target && (e.target.classList.contains(tabSelector.slice(1)) || e.target.parentNode.classList.contains(tabSelector.slice(1)))) {
      tab.forEach((item, index) => {
        if (e.target == item || e.target.parentNode == item) {
          HideTabContent();
          showTabContent(index); // console.log('tab click');
        }
      });
    }
  });
